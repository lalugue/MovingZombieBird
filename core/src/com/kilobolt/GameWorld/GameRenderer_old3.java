...
public class GameRenderer_old3 { //this defines the GameRenderer, which will be created by GameScreen
	...
	public GameRenderer_old3(GameWorld world, int gameHeight, int midPointY)
	{
		myWorld = world;
